...
baidu.fehelper = (function(){
    ...
    var _loadCss = function(){
        ...
        if(!jQuery('#_fehelper_jq_ui_css_')[0]) {
            var jqUiCss = browser.extension.getURL('static/vendor/jquery-ui-1.8/jquery-ui.hot.css');
            jQuery('<link id="_fehelper_jq_ui_css_" href="' + jqUiCss + '" rel="stylesheet" type="text/css" />').appendTo('head');

            var fcpCss = browser.extension.getURL('static/css/fe-helper.css');
	...
	var _doFcpDetect = function(){
		...
		browser.extension.onMessage.addListener(function(request,sender,callback){
			//browserAction被点击
